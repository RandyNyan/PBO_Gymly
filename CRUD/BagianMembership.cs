...
{
    internal class BagianMembership : Database_Gymly
    {
        ...
        public static void AddMembership(Struktur_Membership membershipBaru)
        {
        ...
        public static void UpdateMmembership(Struktur_Membership membership)
        {
